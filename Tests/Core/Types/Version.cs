...
namespace Tests.Core.Types
{
    ...
    public class Version
    {
        ...
        public void Alpha()
        {
            var v1 = new GameVersion("apple");
            var v2 = new GameVersion("banana");
        ...
        public void Basic()
        {
            var v0 = new GameVersion("1.2.0");
            var v1 = new GameVersion("1.2.0");
            var v2 = new GameVersion("1.2.1");
        ...
        {
            var v0 = new GameVersion("1.01");
            var v1 = new GameVersion("1.1");
        ...
        {
            var v0 = new GameVersion("1.0_beta");
            var v1 = new GameVersion("1.0.1_beta");
        ...
        {
            var v0 = new GameVersion("1.0");
            var v1 = new GameVersion("1.0.repackaged");
            var v2 = new GameVersion("1.0.1");
        ...
        {
            var v0 = new GameVersion("1.1.0.0");
            var v1 = new GameVersion("1.1.1");
        ...
        public void Complex()
        {
            var v1 = new GameVersion("v6a12");
            var v2 = new GameVersion("v6a5");
        ...
        {
            var v1 = new GameVersion("1.2.0");
            var v2 = new GameVersion("1:1.2.0");
        ...
        public void AGExt()
        {
            var v1 = new GameVersion("1.20");
            var v2 = new GameVersion("1.22a");
