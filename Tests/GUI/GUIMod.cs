    ...
    public class GUIModTests
    {
        ...
        public void HasUpdateReturnsTrueWhenUpdateAvailible()
        {
            using (var tidy = new DisposableKSP())
            {
                ...
                var old_version = generatror.GeneratorRandomModule(version: new GameVersion("0.24"), ksp_version: tidy.KSP.Version);
                var new_version = generatror.GeneratorRandomModule(version: new GameVersion("0.25"), ksp_version: tidy.KSP.Version,
